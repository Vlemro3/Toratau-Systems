    ...
    <div className="page">
      <div className="page__header">
        ...
        <div className="page__actions" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <button className="btn btn--secondary" onClick={() => navigate('/estimates/create')}>Создать смету</button>
          <button className="btn btn--primary" onClick={() => navigate('/estimates/new')}>+ Загрузить смету</button>
        </div>
      </div>
